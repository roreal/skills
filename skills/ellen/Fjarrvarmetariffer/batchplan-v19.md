...
- **Innehåll:**
  ...
  9. **Namngiven, gemensam produktentry för "aktuell årskostnad" (Stockholm OCH Lidköping),
     ...
     **Gällande definition** (ersätter v13–v18:s indirekta/fail-open varianter — se
     `tariffinventering-v19.md` §6a.4 för den fullständiga historiken/motiveringen):
...
- **Rättat P1 (granskning `2026-09-09-010`) — v16:s motorkod var en fristående skiss utan
  ...
  hjälpfunktionsanrop — se `tariffinventering-v19.md` §6a.7.1–§6a.7.3 för den fullständiga,
...
- **Fail-closed före/efter-regel för besparingsvärdering (nytt P1, granskning
  ...
  `KontraktBlockerat` (se `tariffinventering-v19.md` §6a.4 för klass/guard/UI-mappning).
