...
- [ ] **Kristianstad** (`c4-energi-kristianstad-2026`)
  ...
  - **🟡 Godkänt för årsberäkning, lokalt implementerad bakom spärr 2026-09-14 (Batch 5a, granskning 2026-09-14-012) endast med leverantörens effektgrupp.** Energiperioder, årsformler, effektbelopp och effektgrund stämmer med katalogen. Automatisk gruppindelning vid 500 kW är inte godkänd.
...
- [ ] **Östersund, Frösön, Ås** (`jamtkraft-ostersund-froson-as-2026`)
  - Källor: [officiell prismodell](https://www.jamtkraft.se/foretag/fjarrvarme/priser/prismodell/), [officiell prisändringsmodell och prislista 2026–2028](https://www.jamtkraft.se/wt/documents/519/Pris%C3%A4ndringsmodellen_2026-2028.pdf) (`15_1` s.19–20; `15_0` s.18–19 bevarad som historisk 2025-källa)
  - **🟡 Godkänt för årsberäkning, lokalt aktiverat 2026-09-14 (Batch 4, granskning 2026-09-14-008).** Alla katalogpriser, effektintervall, säsonger och flödesformeln stämmer. Debiteringseffekten är medelvärdet av de tre högsta dygnsmedeleffekterna under de senaste 12 månaderna; ett fastställt värde gäller tills ett högre värde mäts, dock längst 12 månader. Kalkylatorn tar leverantörens redan beräknade värde — ingen fakturamånad krävs och ingen egen tidsserie byggs.
  - [x] Metod för debiterbar effekt/kapacitet verifierad; `billing_basis_method` ifylld och kontraktsgated; lokalt aktiverad (Batch 4, granskning 2026-09-14-008).
  - [ ] Månadsperiodisering saknas eller behöver verifieras; årsbelopp får inte automatiskt delas med 12.
...
- [ ] **Söderhamn företag, taxa 10–13** (`soderhamn-nara-soderhamn-taxa-11-och-12-2026`)
  ...
  - **🟡 Godkänt för årsberäkning, lokalt implementerad bakom spärr 2026-09-14 (Batch 5a, granskning 2026-09-14-012).** Taxa 10–13, fasta årsavgifter, effektformler och energipris stämmer med katalogen. Sidan bekräftar månadsdebitering men inte explicit fördelning av årsbeloppen; använd leverantörens anslutningseffekt.
...
- [ ] **Tierp, Karlholmsbruk och Örbyhus** (`temab-fjarrvarme-tierp-karlholmsbruk-och-orbyhus-2026`)
  ...
  - **🟡 Villkorat godkänt, lokalt implementerad bakom spärr 2026-09-14 (Batch 5a, granskning 2026-09-14-012) endast med TEMAB:s fastställda debiteringseffekt eller anslutningsvärde.** Alla prisbelopp, intervall, momsgrund och kalenderdagsperiodisering stämmer. Taxan säger att kategoritalsmetoden används men publicerar varken kategorital eller vilken energihistorik som ingår; vid nyanslutning eller när metoden inte passar används anslutningsvärdet.
  - [x] Fast avgift periodiseras efter `days_in_month/365` under 2026 och energi efter uppmätt månadsförbrukning.
  - [x] Metod för debiterbar effekt kräver leverantörens debiteringseffekt/anslutningsvärde och bekräftad taxa (`temab_debiteringseffekt_kw`/`temab_vald_taxa_id`). Taxan publicerar inget historik- eller uppdateringsintervall för metoden, så policyn har `rullande=False` med ett konservativt `takad_till_snapshot=True`-tak (ett ogenomskinligt, inte ett bevisat fast, kalenderårsunderlag) — ger `annual/snapshot/complete`, inte `exact` (granskning 2026-09-15-002, P1/P2).
...
- [ ] **Trollhättan** (`trollhattan-energi-trollhattan-2026`)
  ...
  - **🟡 Godkänt för årsberäkning, lokalt implementerad bakom spärr 2026-09-14 (Batch 5a, granskning 2026-09-14-012).** Tre energisäsonger, effektgruppernas fasta och rörliga årsdelar samt regeln för prisgrundande effekt stämmer med katalogen.
...
- [x] **Umeå Enkel** (`umea-energi-umea-enkel-2026`)
  - Källa: [officiell prislista Enkel 2026](https://www.umeaenergi.se/foretag/varme/priser/prisavtal-enkel), [officiell förklaring av prismodellen](https://www.umeaenergi.se/foretag/varme/priser/prismodell) och [gällande särskilda prisvillkor (PDF)](https://a.storyblok.com/f/162274/x/bed500e2ec/prisvillkor-fjarrvarme.pdf) — återverifierade mot dessa aktuella officiella 2026-sidor (Batch 4, handoff 2026-09-14-001); `45_0` s.14 bevarad som historisk källa, `web-review-umea-terms` och `web-review-umea-enkel` uppdaterade med sann proveniens.
  - **🟡 Godkänt för årsberäkning, lokalt aktiverat 2026-09-14 (Batch 4, granskning 2026-09-14-008).** Samtliga 2026-priser, intervall, energisäsonger och flödesformeln är verifierade. Årseffekten är medel av årets tre högsta fasta 12-timmarsblock (06–18/18–06), abonnerad effekt är medel av de tre föregående årseffekterna och hela `(k × A + m)` multipliceras med B. Effektpriset kalenderdagsfördelas. U beräknas av normalårskorrigerad energi december–februari dividerad med september–april, men bolaget publicerar inte metoden för själva normalårskorrigeringen — kalkylatorn räknar därför ALDRIG fram B (eller U) från råa mätvärden. Kontraktet tar direkt leverantörens redan beräknade A och direkt leverantörens redan beräknade B; U förekommer aldrig som kalkylatorindata.
  - [x] Gränserna och B-formlerna är verifierade: 0–0,299 → 0,93; 0,300–0,499 → `0,35U+0,825`; 0,500–0,799 → `1,34U+0,330`; ≥0,800 → 1,40. Formeln är katalog-/policyhygien (`kontrollera_kompositgrind`), inte en beräkning kalkylatorn utför.
  - [x] Kapacitetsmultiplikatorn B är strukturellt bunden och intervallvaliderad ([0,93, 1,401]) genom katalog → policy → kontraktsfasad → motor; lokalt aktiverad (Batch 4, granskning 2026-09-14-008). Andra avtalsalternativ ingår inte.
...
- [ ] **Helsingborg Totalvärme, central installerad före 2024** (`oresundskraft-helsingborg-totalvarme-central-installerad-fore-2024-2026`)
  ...
  - **🟡 Godkänt för årsberäkning, lokalt implementerad bakom spärr 2026-09-14 (Batch 5a, granskning 2026-09-14-012).** Målgruppen, effektformeln, vinterenergipriset och övriga energisäsonger överensstämmer med katalogen. Använd fakturans effektvärde och leverantörens band.
