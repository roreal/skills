...
- [ ] **Östersund, Frösön, Ås** (`jamtkraft-ostersund-froson-as-2026`)
  ...
  - **🟡 Godkänt för årsberäkning, implementerat bakom spärr (Batch 4, handoff 2026-09-14-001).** Alla katalogpriser, effektintervall, säsonger och flödesformeln stämmer. Debiteringseffekten är medelvärdet av de tre högsta dygnsmedeleffekterna under de senaste 12 månaderna; ett fastställt värde gäller tills ett högre värde mäts, dock längst 12 månader. Kalkylatorn tar leverantörens redan beräknade värde — ingen fakturamånad krävs och ingen egen tidsserie byggs.
