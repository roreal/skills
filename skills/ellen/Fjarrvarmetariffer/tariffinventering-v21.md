# Tariffinventering v20.0 — fullständig kontrollmängd för kalkylator v1

Upprättad 2026-09-09 av Claude. Ersätter `tariffinventering-v19.md` i sin helhet (v19 ändras
INTE i efterhand — kvar som historik), som svar på omgranskning
[2026-09-09-013](../conversations/reviews/2026/09/2026-09-09-omgranskning-tariffinventering-v19.md)
(`status: changes-required`, supersedes `2026-09-09-012`) av v19/`batchplan-v19.md`. Ingen
...
blockerade / 92 totalt** (bas 7/47/24, variant 0/10/4; se §4.2 och §8) — v20 gör bara
...
**Vad som är nytt i v20, i korthet** (se granskning `2026-09-09-013` för fullständig
