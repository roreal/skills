...
main() {
  ...
  # EXIT sköter alltid låsstädningen. Signalspecifika traps måste
  # dessutom AVSLUTA processen; den tidigare gemensamma `release_lock`-
  # trapen returnerade bara och lät poll-loopen fortsätta utan lås, vilket
  # kunde skapa en osynlig parallell bevakare efter Ctrl-C.
